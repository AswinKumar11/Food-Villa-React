        ...
        <>
            <div className="bg-gray-300 w-72 h-48 fixed border-2 border-black rounded-md">
                ...
                <div className="m-3 p-3 flex justify-center">
                    <button className="bg-blue-400 hover:bg-red-400  m-2 p-2 border-2 border-black rounded-md" onClick={()=>{
                    ...
                    <button className="bg-blue-400  hover:bg-green-400 m-2 p-2 border-2 border-black rounded-md" onClick={()=>{
                        setShowPopUp(!showPopUp);
                    }}>Cancel</button>
                </div>
